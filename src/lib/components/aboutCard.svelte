		...
		<div class="w-full max-h-full">
			<div class="rounded-lg shadow bg-surface-100-800-token">
				<div class="py-4 px-2 border-b rounded-t">
					<div class="pl-4 pr-4">
						<p class="pb-1 text-xl font-medium leading-8">About</p>

						<p class="text-sm font-medium">
							This website collects, organizes, and showcases documented information, in terms of
							the specific messages, that various underwater and surface actors may need to exchange
							during a recreational or professional dive (Figure 1). The messages that need to or
							can be conveyed depend on the location and time of the specific actor sending and/or
							receiving the message. Furthermore, the messages can be exchanged through various
							communication methods such as body language, flags & buoys, hand signals, light
							signals, etc. In the following sections, we thus describe these aspects to introduce
				...
				<div class="py-4 px-2 border-b rounded-t">
					<div class="pl-4 pr-4">
						<p class="pb-1 text-xl font-medium leading-8">Message Encoders & Decoders</p>
						<p class="text-sm font-medium">
							Communication involves a sender who encodes a message (the message encoder) and a
							receiver who decodes that message (the message decoder). In this context, the message
							is the information or meaning conveyed from the sender to the receiver. Thus the
							sender must use a common language for the message to be understood by the receiver. In
							the context of Figure 1, we can identify relevant actors that typically exchange
							messages, i.e., encode or decode messages. In the following, we describe the most
							relevant ones in more detail.
						</p>
				...
				<div class="py-4 px-2 border-b rounded-t">
					<div class="pl-4 pr-4">
						<p class="pb-1 text-xl font-medium leading-8">Spatial & Temporal Context</p>
						<p class="text-sm font-medium">
							...
							information between individuals can occur at the same time (synchronous) or at
							different times (asynchronous). (ii) The second dimension pertains to whether
							colocated or remote individuals are considered. Conclusively, methods of communication
							can be categorized into four distinct categories: Colocated and synchronous, remote
							and synchronous, colocated and asynchronous, and remote and asynchronous. We will
							provide more details on the individual components of the two dimensions in the
							following.
						</p>

						<!-- Spatial Aspect -->
						<p class="flex items-center p-2 pb-0 pt-2 text-l font-medium leading-8">
							<img class="mx-2" src={colocatedLoc} width="28" height="28" alt="Message" />
							Colocated
						</p>
						<p class="flex p-2 mx-2 text-sm font-medium">
						...
						<p class="flex items-center p-2 pb-0 pt-2 text-l font-medium leading-8">
							<img class="mx-2" src={remoteLoc} width="28" height="28" alt="Message" />
							Remote
						</p>
						<p class="flex p-2 mx-2 text-sm font-medium">
						...
						<!-- Temporal Aspect -->
						<p class="flex items-center p-2 pb-0 pt-2 text-l font-medium leading-8">
							<img class="mx-2" src={syncLoc} width="28" height="28" alt="Message" />
							Synchronous
						</p>
						<p class="flex p-2 mx-2 text-sm font-medium">
						...
						<p class="flex items-center p-2 pb-0 pt-2 text-l font-medium leading-8">
							<img class="mx-2" src={asyncLoc} width="28" height="28" alt="Message" />
							Asynchronous
						</p>
						<p class="flex p-2 mx-2 text-sm font-medium">
				...
				<div class="py-4 px-2 border-b rounded-t">
					<div class="pl-4 pr-4">
						<p class="pb-1 text-xl font-medium leading-8">Communication Methods</p>
						<p class="text-sm font-medium">
							...
							communication methods and their characteristics and use. The methods we describe have
							a set of standard use cases and signals with agreed-upon meanings. However, many
							methods allow the definition of other signals with possibly new meanings. Agreeing on
							the signals and their meanings is typically established during dive planning to ensure
				...
				<div class="py-4 px-2 border-b rounded-t">
					<div class="pl-4 pr-4">
						<p class="pb-1 text-xl font-medium leading-8">Message Categories</p>
						<p class="text-sm font-medium">TODO: ...</p>

						<p class="flex items-center p-2 pb-0 pt-2 text-l font-medium leading-8">
							Emotions & Expressions (EE)
						</p>
						<p class="flex p-2 mx-2 text-sm font-medium">TODO: ...</p>
				...
				<div class="py-4 px-2 border-b rounded-t">
					<div class="pl-4 pr-4">
						<p class="pb-1 text-xl font-medium leading-8">Bibliography</p>
						...
						<table class="text-sm font-medium border-separate border-spacing-2">
							...
							<tr>
								...
								<td class="pl-4">
									<p>
										Behnke, Lars. <cite>Scuba Diving Hand Signals</cite>, 2nd Black & White Edition,
										(2023). Published by: Independent publication.
									</p>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="pl-4">
									<p>
										NOAA Diving Program (U.S.). <cite
											>NOAA Diving Manual: Diving for Science and Technology</cite
										>, 4th Edition, (2001). Published by: The National Oceanic and Atmospheric
										Administration (NOAA) & U.S. Department of Commerce and Best Publishing Company.
									</p>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="pl-4">
									<p>
										U.S. Navy Diving. <cite>U.S. Navy Diving Manual</cite>, Revision 7, (2016).
							...
							<tr>
								...
								<td class="pl-4">
									<p>
										Prosser, Joe and Grey, H.V. <cite>Cave Diving Communications</cite>, 1st
										Edition, (1990). Published by: Branford, Florida: Cave Diving Section of the
							...
							<tr>
								...
								<td class="pl-4">
									<p>
										Richardson, Drew et al. <cite>PADI Open Water Diver Manual</cite>, Version 2.09,
										(2007). Published by: Rancho Santa Margarita, California: PADI.
									</p>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="pl-4">
									<p>
										Richardson, Drew et al. <cite>PADI Adventures in Diving</cite>, Version 2.4,
										(2004). Published by: Rancho Santa Margarita, California: PADI.
									</p>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="pl-4">
									<p>
										PADI. <cite>PADI Advanced Open Water Diver Manual</cite>, Version 1.0, (2016).
										Published by: Rancho Santa Margarita, California: PADI.
									</p>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="pl-4">
									<p>
										Recreational Scuba Training Council (RSTC), Inc. <cite
											>Common Hand Signals for Scuba Diving</cite
										>, (2005). Published by: Florida, Jackonville: Recreational Scuba Training
										Council (RSTC), Inc.
									</p>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="pl-4">
									<p>
										Bevan, John. <cite>The Professional Diver's Handbook</cite>, 2nd Edition,
										(2006). Published by: Submex Limited.
									</p>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="pl-4">
									<p>
										Emergency Response Diving International (ERDI). <cite
											>ERDI Standards and Procedures. Part 2: ERDI Diver Standards</cite
										>, Version 0123, (2022). Published by: Emergency Response Diving International
										(ERDI).
									</p>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="pl-4">
									<p>
										van Stijn, Dave and Harterink, Mike. <cite
											>Scubasigns: The Guide to All Diving Hand Signals</cite
										>, (2009). Published by: Scubasigns Foundation.
									</p>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="pl-4">
									<p>
										DeMarco, K. J. and West, M. E. and Howard, A. M. <cite
											>Underwater Human-Robot Communication: A Case Study with Human Divers
										</cite> 2014 IEEE International Conference on Systems, Man, and Cybernetics (SMC),
										San Diego, CA, USA, 2014, pp. 3738-3743, doi: 10.1109/SMC.2014.6974512.
									</p>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="pl-4">
									<p>
										Nađ, Ð. et al. <cite
											>Diver-Robot Communication Using Earable Sensing Diver Glove</cite
										> OCEANS 2021: San Diego - Porto, San Diego, CA, USA, 2021, pp. 1-6, doi: 10.23919/OCEANS44145.2021.9706117.
									</p>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="pl-4">
									<p>
										Johansen, Robert. <cite>Groupware: Computer Support for Business Teams</cite>,
										(2022). Published by: The Free Press.
									</p>
								</td>
							</tr>
						</table>
				...
				<div class="py-4 px-2 border-b rounded-t">
					<div class="pl-4 pr-4">
						<p class="pb-1 text-xl font-medium leading-8">Citing This Website</p>
				...
				<div class="py-4 px-2">
					<div class="pl-4 pr-4">
						<p class="pb-1 text-xl font-medium leading-8">Website Source Code</p>
						<p class="text-sm font-medium">
